...
extern "C" JNIEXPORT void JNICALL Java_info_kingpes_echoandroid_EchoBridge_createSLEngine(
...
Java_info_kingpes_echoandroid_EchoBridge_configureEcho(JNIEnv *env, jclass type,
                                                       jint delayInMs,
                                                       jfloat decay) {
  engine.echoDelay_ = delayInMs;
  engine.echoDecay_ = decay;
...
extern "C" JNIEXPORT jboolean JNICALL
Java_info_kingpes_echoandroid_EchoBridge_createSLBufferQueueAudioPlayer(
...
Java_info_kingpes_echoandroid_EchoBridge_deleteSLBufferQueueAudioPlayer(
    JNIEnv *env, jclass type) {
  if (engine.player_) {
...
extern "C" JNIEXPORT jboolean JNICALL
Java_info_kingpes_echoandroid_EchoBridge_createAudioRecorder(JNIEnv *env,
                                                             jclass type) {
  SampleFormat sampleFormat;
  memset(&sampleFormat, 0, sizeof(sampleFormat));
...
extern "C" JNIEXPORT void JNICALL
Java_info_kingpes_echoandroid_EchoBridge_deleteAudioRecorder(JNIEnv *env,
                                                             jclass type) {
...
extern "C" JNIEXPORT void JNICALL
Java_info_kingpes_echoandroid_EchoBridge_startPlay(JNIEnv *env, jclass type) {
...
extern "C" JNIEXPORT void JNICALL
Java_info_kingpes_echoandroid_EchoBridge_stopPlay(JNIEnv *env, jclass type) {
...
extern "C" JNIEXPORT void JNICALL Java_info_kingpes_echoandroid_EchoBridge_deleteSLEngine(
    JNIEnv *env, jclass type) {
